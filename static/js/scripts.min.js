if (
  ((function (t, e) {
    ...
    function r() {
      it.addEventListener
        ? (it.removeEventListener('DOMContentLoaded', a), t.removeEventListener('load', a))
      ...
      if (void 0 === i && 1 === t.nodeType) {
        ...
        if ('string' == typeof (i = t.getAttribute(n))) {
          try {
            i =
              'true' === i ||
              ('false' !== i && ('null' === i ? null : +i + '' === i ? +i : Ot.test(i) ? dt.parseJSON(i) : i));
          } catch (t) {}
          dt.data(t, e, i);
        } else i = void 0;
      }
        ...
        if ((u && l[u] && (n || l[u].data)) || void 0 !== i || 'string' != typeof e)
          return (
            ...
            ('object' != typeof e && 'function' != typeof e) ||
              (n ? (l[u] = dt.extend(l[u], e)) : (l[u].data = dt.extend(l[u].data, e))),
            (s = l[u]),
      ...
      if (At(t)) {
        ...
        if (r[a]) {
          ...
          (i || (delete r[a].data, u(r[a]))) &&
            (s ? dt.cleanData([t], !0) : ct.deleteExpando || r != r.window ? delete r[a] : (r[a] = void 0));
        }
      }
    }
    function d(t, e, i, n) {
    ...
    function v(t, e, i, n, o) {
      for (var s, r, a, l, u, c, h, d = t.length, v = p(e), y = [], w = 0; d > w; w++)
        if ((r = t[w]) || 0 === r)
          if ('object' === dt.type(r)) dt.merge(y, r.nodeType ? [r] : r);
            ...
            for (
              ...
              l = l.lastChild;
            if ((!ct.leadingWhitespace && Wt.test(r) && y.push(e.createTextNode(Wt.exec(r)[0])), !ct.tbody))
              for (
                s =
                  (r = 'table' !== u || Bt.test(r) ? ('<table>' !== h[1] || Bt.test(r) ? 0 : l) : l.firstChild) &&
                  r.childNodes.length;
                s--;

              )
                dt.nodeName((c = r.childNodes[s]), 'tbody') && !c.childNodes.length && r.removeChild(c);
            for (dt.merge(y, l.childNodes), l.textContent = ''; l.firstChild; ) l.removeChild(l.firstChild);
            l = v.lastChild;
          } else y.push(e.createTextNode(r));
      for (l && v.removeChild(l), ct.appendChecked || dt.grep(f(y, 'input'), g), w = 0; (r = y[w++]); )
    ...
    function T(t, e) {
      return dt.nodeName(t, 'table') && dt.nodeName(11 !== e.nodeType ? e : e.firstChild, 'tr')
      ...
      if (1 === e.nodeType) {
        ...
        'script' === i && e.text !== t.text
          ...
          ? (e.parentNode && (e.outerHTML = t.outerHTML),
            ct.html5Clone && t.innerHTML && !dt.trim(e.innerHTML) && (e.innerHTML = t.innerHTML))
    ...
    function D(t, e, i, n) {
      ...
      if (
        h &&
        ((u = v(e, t[0].ownerDocument, !1, t, n)), (o = u.firstChild), 1 === u.childNodes.length && (u = o), o || n)
      ) {
        for (r = (a = dt.map(f(u, 'script'), C)).length; h > c; c++)
          (s = u), c !== d && ((s = dt.clone(s, !0, !0)), r && dt.merge(a, f(s, 'script'))), i.call(t[c], s, c);
        if (r)
          for (l = a[a.length - 1].ownerDocument, dt.map(a, _), c = 0; r > c; c++)
            (s = a[c]),
              jt.test(s.type || '') &&
                ...
                (s.src
                  ...
                  : dt.globalEval((s.text || s.textContent || s.innerHTML || '').replace(ne, '')));
        u = o = null;
      }
      return t;
    }
    ...
    function A(t) {
      ...
      return (
        i ||
          (('none' !== (i = I(t, e)) && i) ||
            ((se = (se || dt("<iframe frameborder='0' width='0' height='0'/>")).appendTo(e.documentElement)),
            (e = (se[0].contentWindow || se[0].contentDocument).document).write(),
            e.close(),
            (i = I(t, e)),
            se.detach()),
          (re[t] = i)),
        ...
        (n = t[r]).style &&
          ...
          e
            ? (s[r] || 'none' !== i || (n.style.display = ''),
              '' === n.style.display && zt(n) && (s[r] = dt._data(n, 'olddisplay', A(n.nodeName))))
            : ((o = zt(n)), ((i && 'none' !== i) || !o) && dt._data(n, 'olddisplay', o ? i : dt.css(n, 'display'))));
      for (r = 0; a > r; r++)
        (n = t[r]).style &&
          ((e && 'none' !== n.style.display && '' !== n.style.display) || (n.style.display = e ? s[r] || '' : 'none'));
      return t;
    }
    function L(t, e, i) {
      var n = ve.exec(e);
        ...
        'margin' === i && (r += dt.css(t, i + $t[s], !0, o)),
          n
            ? ('content' === i && (r -= dt.css(t, 'padding' + $t[s], !0, o)),
              'margin' !== i && (r -= dt.css(t, 'border' + $t[s] + 'Width', !0, o)))
            : ((r += dt.css(t, 'padding' + $t[s], !0, o)),
              'padding' !== i && (r += dt.css(t, 'border' + $t[s] + 'Width', !0, o)));
      return r;
    }
    function z(t, e, i) {
      var n = !0,
    ...
    function F(t, e) {
      var i,
        n = { height: t },
        o = 0;
      for (e = e ? 1 : 0; 4 > o; o += 2 - e) (i = $t[o]), (n['margin' + i] = n['padding' + i] = t);
      return e && (n.opacity = n.width = t), n;
    }
    function j(t, e, i) {
      for (var n, o = (H.tweeners[e] || []).concat(H.tweeners['*']), s = 0, r = o.length; r > s; s++)
    ...
    function H(t, e, i) {
      var n,
        ...
        l = function () {
          ...
          for (
            ...
            u.tweens[s].run(n);
          return a.notifyWith(t, [u, n, i]), 1 > n && r ? i : (a.resolveWith(t, [u]), !1);
        },
        u = a.promise({
          elem: t,
          props: dt.extend({}, e),
          opts: dt.extend(!0, { specialEasing: {}, easing: dt.easing._default }, i),
      ...
      for (W(c, u.opts.specialEasing); r > s; s++)
        if ((n = H.prefilters[s].call(u, t, c, u.opts)))
          return dt.isFunction(n.stop) && (dt._queueHooks(u.elem, u.opts.queue).stop = dt.proxy(n.stop, n)), n;
      return (
        dt.map(c, j, u),
                ...
                (t = r[n]),
                  ...
                  r !== i &&
                    (u && i && (dt.isPlainObject(i) || (e = dt.isArray(i)))
                      ? (e ? ((e = !1), (s = t && dt.isArray(t) ? t : [])) : (s = t && dt.isPlainObject(t) ? t : {}),
                        (r[n] = dt.extend(u, s, i)))
                      : void 0 !== i && (r[n] = i));
          return r;
        }),
    ...
    var vt = (function (t) {
        ...
        if (!n && ((e ? e.ownerDocument || e : R) !== A && I(e), (e = e || A), M)) {
          if (11 !== m && (h = mt.exec(t)))
            if ((o = h[1])) {
              ...
              } else if (f && (r = f.getElementById(o)) && z(e, r) && r.id === o) return i.push(r), i;
            } else {
              if (h[2]) return Z.apply(i, e.getElementsByTagName(t)), i;
              if ((o = h[3]) && w.getElementsByClassName && e.getElementsByClassName)
          ...
          if (w.qsa && !q[t + ' '] && (!N || !N.test(t))) {
            if (1 !== m) (f = e), (p = t);
              ...
              for (
                (a = e.getAttribute('id')) ? (a = a.replace(vt, '\\$&')) : e.setAttribute('id', (a = P)),
                  s = (d = C(t)).length,
                  u = ct.test(a) ? '#' + a : "[id='" + a + "']";
                s--;
        ...
        return (
          ...
          n(function (n, r, a, l) {
            var u,
              ...
              w = i ? (s || (n ? t : g || o) ? [] : r) : y;
            if ((i && i(y, w, a, l), o))
              for (u = f(w, m), o(u, [], a, l), c = u.length; c--; ) (h = u[c]) && (w[m[c]] = !(y[m[c]] = h));
            if (n) {
              if (s || t) {
                if (s) {
        ...
        for (
          ...
          if ((i = b.relative[t[a].type])) p = [h(d(p), i)];
            ...
            if ((i = b.filter[t[a].type].apply(null, t[a].matches))[P]) {
              ...
              return m(
                a > 1 && d(p),
                a > 1 && c(t.slice(0, a - 1).concat({ value: ' ' === t[a - 2].type ? '*' : '' })).replace(st, '$1'),
                i,
                n > a && g(t.slice(a, n)),
                o > n && g((t = t.slice(n))),
                o > n && c(t)
        ...
        var o = i.length > 0,
          ...
          r = function (n, r, a, l, u) {
            ...
            for (u && (S = r === A || r || u); m !== T && null != (c = w[m]); m++) {
              if (s && c) {
                for (h = 0, r || c.ownerDocument === A || (I(c), (a = !M)); (d = t[h++]); )
                  if (d(c, r || A, a)) {
                    l.push(c);
                    break;
                  }
      ...
      try {
        Z.apply((V = G.call(R.childNodes)), R.childNodes), V[R.childNodes.length].nodeType;
      } catch (t) {
        Z = {
          apply: V.length
            ? function (t, e) {
      ...
      (w = e.support = {}),
            ...
            return n !== A && 9 === n.nodeType && n.documentElement
              ? ((A = n),
                ...
                (w.getById = o(function (t) {
                  return (O.appendChild(t).id = P), !A.getElementsByName || !A.getElementsByName(P).length;
                })),
                w.getById
                ...
                (w.matchesSelector = ft.test(
                  ...
                  o(function (t) {
                    (w.disconnectedMatch = $.call(t, 'div')), $.call(t, "[s!='']:x"), L.push('!=', nt);
                  }),
        ...
        (e.matchesSelector = function (t, i) {
          if (
            ...
            (i = i.replace(lt, "='$1']")),
            w.matchesSelector && M && !q[i + ' '] && (!L || !L.test(i)) && (!N || !N.test(i)))
          )
            try {
              var n = $.call(t, i);
                        ...
                        if (((f = [r ? g.firstChild : g.lastChild]), r && y)) {
                          for (
                            w =
                              (p =
                                (u =
                                  (c = (h = (d = g)[P] || (d[P] = {}))[d.uniqueID] || (h[d.uniqueID] = {}))[t] ||
                                  [])[0] === F && u[1]) && u[2],
                              d = p && g.childNodes[p];
          ...
          function (t, i) {
            ...
            for (a = t, l = [], u = b.preFilter; a; ) {
              (n && !(o = rt.exec(a))) || (o && (a = a.slice(o[0].length) || a), l.push((s = []))),
                (n = !1),
                (o = at.exec(a)) &&
                  ((n = o.shift()), s.push({ value: n, type: o[0].replace(st, ' ') }), (a = a.slice(n.length)));
              for (r in b.filter)
                !(o = ht[r].exec(a)) ||
                  (u[r] && !(o = u[r](o))) ||
                  ((n = o.shift()), s.push({ value: n, type: r, matches: o }), (a = a.slice(n.length)));
              if (!n) break;
            }
        ...
        (_ = e.compile =
          function (t, e) {
            var i,
              ...
              s = q[t + ' '];
            if (!s) {
              for (e || (e = C(t)), i = e.length; i--; ) (s = g(e[i]))[P] ? n.push(s) : o.push(s);
        ...
        (k = e.select =
          function (t, e, i, n) {
            ...
            if (((i = i || []), 1 === d.length)) {
              ...
              for (o = ht.needsContext.test(t) ? 0 : s.length; o-- && ((r = s[o]), !b.relative[(a = r.type)]); )
                if (
                  (u = b.find[a]) &&
                  (n = u(r.matches[0].replace(yt, wt), (gt.test(s[0].type) && l(e.parentNode)) || e))
                ) {
                  if ((s.splice(o, 1), !(t = n.length && c(s)))) return Z.apply(i, n), i;
                  break;
                }
            }
            return (h || _(t, d))(n, e, !M, i, !e || (gt.test(t) && l(e.parentNode)) || e), i;
          }),
    ...
    ((dt.fn.init = function (t, e, i) {
      ...
      if (((i = i || Ct), 'string' == typeof t)) {
        if (
          !(n =
            '<' === t.charAt(0) && '>' === t.charAt(t.length - 1) && t.length >= 3 ? [null, t, null] : _t.exec(t)) ||
          (!n[1] && e)
        )
      ...
      return t.nodeType
        ...
        ? void 0 !== i.ready
          ? i.ready(t)
          : t(dt)
        : (void 0 !== t.selector && ((this.selector = t.selector), (this.context = t.context)), dt.makeArray(t, this));
    }).prototype = dt.fn),
      (Ct = dt(it));
    ...
    dt.fn.extend({
      ...
      closest: function (t, e) {
        for (
          var i, n = 0, o = this.length, s = [], r = bt.test(t) || 'string' != typeof t ? dt(t, e || this.context) : 0;
          o > n;
          n++
        )
                    ...
                    dt.each(e, function (e, s) {
                      ...
                      o[s[1]](function () {
                        ...
                        t && dt.isFunction(t.promise)
                          ...
                          : i[s[0] + 'With'](this === n ? i.promise() : this, r ? [t] : arguments);
                      });
                    }),
                      (t = null);
                  })
          ...
          if (r > 1)
            for (e = new Array(r), i = new Array(r), n = new Array(r); r > o; o++)
              s[o] && dt.isFunction(s[o].promise)
                ? s[o].promise().progress(u(o, i, e)).done(u(o, n, s)).fail(l.reject)
                : --a;
        ...
        ready: function (t) {
          (!0 === t ? --dt.readyWait : dt.isReady) ||
            ...
            (!0 !== t && --dt.readyWait > 0) ||
              ...
              dt.fn.triggerHandler && (dt(it).triggerHandler('ready'), dt(it).off('ready'))));
        },
      }),
        ...
        data: function (t, e) {
          ...
          if (void 0 === t) {
            if (this.length && ((o = dt.data(s)), 1 === s.nodeType && !dt._data(s, 'parsedAttrs'))) {
              for (i = r.length; i--; )
                r[i] && 0 === (n = r[i].name).indexOf('data-') && ((n = dt.camelCase(n.slice(5))), l(s, n, o[n]));
      ...
      dt.fn.extend({
        ...
        promise: function (t, e) {
          ...
          for ('string' != typeof t && ((e = t), (t = void 0)), t = t || 'fx'; r--; )
            (i = dt._data(s[r], t + 'queueHooks')) && i.empty && (n++, i.empty.add(a));
    ...
    (dt.event = {
              ...
              p &&
                ...
                (d = r[p]) ||
                  ...
                  (u.setup && !1 !== u.setup.call(t, n, f, c)) ||
                    (t.addEventListener ? t.addEventListener(p, c, !1) : t.attachEvent && t.attachEvent('on' + p, c))),
              ...
              for (
                ...
                (r = d[s]),
                  (!o && m !== r.origType) ||
                    ...
                    (d.splice(s, 1), r.selector && d.delegateCount--, h.remove && h.remove.call(t, r));
              l &&
                !d.length &&
                ((h.teardown && !1 !== h.teardown.call(t, f, g.handle)) || dt.removeEvent(t, p, g.handle), delete c[p]);
      ...
      trigger: function (e, i, n, o) {
        ...
        if (
          ...
          if (!o && !u.noBubble && !dt.isWindow(n)) {
            for (l = u.delegateType || p, Xt.test(l + p) || (a = a.parentNode); a; a = a.parentNode) d.push(a), (c = a);
          ...
          for (h = 0; (a = d[h++]) && !e.isPropagationStopped(); )
            (e.type = h > 1 ? l : u.bindType || p),
              ...
              (s = r && a[r]) &&
                s.apply &&
                At(a) &&
                ((e.result = s.apply(a, i)), !1 === e.result && e.preventDefault());
          if (
            ((e.type = p),
            !o &&
      ...
      dispatch: function (t) {
        ...
        if (((a[0] = t), (t.delegateTarget = this), !u.preDispatch || !1 !== u.preDispatch.call(this, t))) {
          for (r = dt.event.handlers.call(this, t, l), e = 0; (o = r[e++]) && !t.isPropagationStopped(); )
            for (t.currentTarget = o.elem, i = 0; (s = o.handlers[i++]) && !t.isImmediatePropagationStopped(); )
              (t.rnamespace && !t.rnamespace.test(s.namespace)) ||
                ((t.handleObj = s),
                (t.data = s.data),
                void 0 !== (n = ((dt.event.special[s.origType] || {}).handle || s.handler).apply(o.elem, a)) &&
                  !1 === (t.result = n) &&
            ...
            if (1 === l.nodeType && (!0 !== l.disabled || 'click' !== t.type)) {
              for (n = [], i = 0; a > i; i++)
                (s = e[i]),
                  (o = s.selector + ' '),
                  void 0 === n[o] &&
                    (n[o] = s.needsContext ? dt(o, this).index(l) > -1 : dt.find(o, this, null, [l]).length),
                  n[o] && n.push(s);
      ...
      fix: function (t) {
        ...
        var e,
          ...
          r = this.fixHooks[o];
        for (
          r || (this.fixHooks[o] = r = Qt.test(o) ? this.mouseHooks : Vt.test(o) ? this.keyHooks : {}),
            ...
            handle: function (t) {
              ...
              return (
                (o && (o === n || dt.contains(n, o))) ||
                  ((t.type = s.origType), (i = s.handler.apply(this, arguments)), (t.type = e)),
                i
              );
            },
          };
        ...
        (dt.event.special.submit = {
          setup: function () {
            return (
              ...
              void dt.event.add(this, 'click._submit keypress._submit', function (t) {
                var e = t.target,
      ...
      clone: function (t, e, i) {
        ...
        if (
          (ct.html5Clone || dt.isXMLDoc(t) || !Kt.test('<' + t.nodeName + '>')
            ? (s = t.cloneNode(!0))
            : ((oe.innerHTML = t.outerHTML), oe.removeChild((s = oe.firstChild))),
          !((ct.noCloneEvent && ct.noCloneChecked) || (1 !== t.nodeType && 11 !== t.nodeType) || dt.isXMLDoc(t)))
        )
          for (n = f(s), a = f(t), r = 0; null != (o = a[r]); ++r) n[r] && S(o, n[r]);
        if (e)
          if (i) for (a = a || f(t), n = n || f(s), r = 0; null != (o = a[r]); r++) k(o, n[r]);
          else k(t, s);
        return (n = f(s, 'script')).length > 0 && m(n, !l && f(t, 'script')), (n = a = o = null), s;
      },
      cleanData: function (t, e) {
        for (
          var i, n, o, s, r = 0, a = dt.expando, l = dt.cache, u = ct.attributes, c = dt.event.special;
          null != (i = t[r]);
          r++
        )
          if ((e || At(i)) && ((o = i[a]), (s = o && l[o]))) {
            ...
            l[o] &&
              (delete l[o], u || void 0 === i.removeAttribute ? (i[a] = void 0) : i.removeAttribute(a), et.push(o));
          }
      },
    }),
      dt.fn.extend({
        ...
        text: function (t) {
          return Pt(
            ...
            function (t) {
              return void 0 === t
                ? dt.text(this)
                : this.empty().append(((this[0] && this[0].ownerDocument) || it).createTextNode(t));
            },
            null,
            t,
            arguments.length
        ...
        function (t, e) {
          dt.fn[t] = function (t) {
            for (var i, n = 0, o = [], s = dt(t), r = s.length - 1; r >= n; n++)
              (i = n === r ? this : this.clone(!0)), dt(s[n])[e](i), st.apply(o, i.get());
    ...
    !(function () {
      ...
      u.style &&
        ...
        (u.innerHTML = ''),
        l.appendChild(u),
        (ct.boxSizing = '' === u.style.boxSizing || '' === u.style.MozBoxSizing || '' === u.style.WebkitBoxSizing),
        dt.extend(ct, {
    ...
    t.getComputedStyle
      ? ((he = function (e) {
        ...
        (de = function (t, e, i) {
          ...
          return (
            (i = i || he(t)),
            ('' !== (r = i ? i.getPropertyValue(e) || i[e] : void 0) && void 0 !== r) ||
    ...
    dt.extend({
      ...
      style: function (t, e, i, n) {
        if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
          var o,
            ...
            l = t.style;
          if (
            ((e = dt.cssProps[a] || (dt.cssProps[a] = M(a) || a)), (r = dt.cssHooks[e] || dt.cssHooks[a]), void 0 === i)
          )
            return r && 'get' in r && void 0 !== (o = r.get(t, !1, n)) ? o : l[e];
          if (
            ('string' === (s = typeof i) && (o = Lt.exec(i)) && o[1] && ((i = d(t, e, o)), (s = 'number')),
            null != i &&
              i === i &&
              ('number' === s && (i += (o && o[3]) || (dt.cssNumber[a] ? '' : 'px')),
      ...
      (dt.cssHooks.marginRight = O(ct.reliableMarginRight, function (t, e) {
        return e ? ue(t, { display: 'inline-block' }, de, [t, 'marginRight']) : void 0;
      })),
        ...
        run: function (t) {
          ...
          return (
            this.options.duration
              ? (this.pos = e = dt.easing[this.easing](t, this.options.duration * t, 0, 1, this.options.duration))
              : (this.pos = e = t),
      ...
      (P.propHooks = {
        _default: {
          ...
          set: function (t) {
            dt.fx.step[t.prop]
              ? dt.fx.step[t.prop](t)
              : 1 !== t.elem.nodeType || (null == t.elem.style[dt.cssProps[t.prop]] && !dt.cssHooks[t.prop])
              ? (t.elem[t.prop] = t.now)
    ...
    (dt.Animation = dt.extend(H, {
      ...
      tweener: function (t, e) {
        ...
        for (var i, n = 0, o = t.length; o > n; n++)
          (i = t[n]), (H.tweeners[i] = H.tweeners[i] || []), H.tweeners[i].unshift(e);
      },
      prefilters: [
        function (t, e, i) {
          var n,
          ...
          i.queue ||
            ...
            1 === t.nodeType &&
              ...
              'inline' === ('none' === (u = dt.css(t, 'display')) ? dt._data(t, 'olddisplay') || A(t.nodeName) : u) &&
                'none' === dt.css(t, 'float') &&
          ...
          if (dt.isEmptyObject(h)) 'inline' === ('none' === u ? A(t.nodeName) : u) && (d.display = u);
            ...
            for (n in h)
              (r = j(p ? f[n] : 0, n, c)),
                n in f ||
                  ((f[n] = r.start), p && ((r.end = r.start), (r.start = 'width' === n || 'height' === n ? 1 : 0)));
          }
        },
      ],
          ...
          return (
            ...
            this.each(function () {
              var e,
                ...
                s = dt.timers,
                r = n ? n.length : 0;
              for (i.finish = !0, dt.queue(this, t, []), o && o.stop && o.stop.call(this, !0), e = s.length; e--; )
    ...
    dt.fn.extend({
      val: function (t) {
        ...
        return arguments.length
          ...
          : o
          ? (e = dt.valHooks[o.type] || dt.valHooks[o.nodeName.toLowerCase()]) &&
            'get' in e &&
          ...
          select: {
            get: function (t) {
              for (
                ...
                if (
                  ((i = n[l]).selected || l === o) &&
                  (ct.optDisabled ? !i.disabled : null === i.getAttribute('disabled')) &&
                  (!i.parentNode.disabled || !dt.nodeName(i.parentNode, 'optgroup'))
                ) {
            ...
            set: function (t, e) {
              for (var i, n, o = t.options, s = dt.makeArray(e), r = o.length; r--; )
    ...
    dt.fn.extend({
        ...
        attr: function (t, e, i) {
          ...
          if (3 !== s && 8 !== s && 2 !== s)
            return void 0 === t.getAttribute
              ? dt.prop(t, e, i)
              : ((1 === s && dt.isXMLDoc(t)) ||
                  ((e = e.toLowerCase()), (o = dt.attrHooks[e] || (dt.expr.match.bool.test(e) ? Ie : Ee))),
                void 0 !== i
                  ? null === i
      ...
      dt.each(dt.expr.match.bool.source.match(/\w+/g), function (t, e) {
        ...
        (Ne && Me) || !Oe.test(e)
          ? (Ae[e] = function (t, e, n) {
              var o, s;
              return n || ((s = Ae[e]), (Ae[e] = o), (o = null != i(t, e, n) ? e.toLowerCase() : null), (Ae[e] = s)), o;
            })
          : (Ae[e] = function (t, e, i) {
    ...
    dt.fn.extend({
      ...
      dt.extend({
        prop: function (t, e, i) {
          ...
          if (3 !== s && 8 !== s && 2 !== s)
            return (
              (1 === s && dt.isXMLDoc(t)) || ((e = dt.propFix[e] || e), (o = dt.propHooks[e])),
              void 0 !== i
                ? o && 'set' in o && void 0 !== (n = o.set(t, i, e))
                  ? n
                  : (t[e] = i)
      ...
      (dt.parseXML = function (e) {
        ...
        try {
          t.DOMParser
            ...
            : ((i = new t.ActiveXObject('Microsoft.XMLDOM')), (i.async = 'false'), i.loadXML(e));
        } catch (t) {
          i = void 0;
        }
        return (
          (i && i.documentElement && !i.getElementsByTagName('parsererror').length) || dt.error('Invalid XML: ' + e), i
        );
      });
    var We = /#.*$/,
      He = /([?&])_=[^&]*/,
      ...
      ajax: function (e, i) {
        function n(e, i, n, o) {
          ...
          2 !== b &&
            ...
            s
              ? (d.ifModified &&
                  ((x = T.getResponseHeader('Last-Modified')) && (dt.lastModified[r] = x),
            ...
            g.fireWith(p, [T, C]),
            u && (f.trigger('ajaxComplete', [T, d]), --dt.active || dt.event.trigger('ajaxStop')));
        }
        ...
        if (
          ...
          (T.success = T.done),
          (T.error = T.fail),
          (d.url = ((e || d.url || Ge) + '').replace(We, '').replace(Ye, Ke[1] + '//')),
          ...
          null == d.crossDomain &&
            ...
            (d.crossDomain = !(
              ...
              (o[1] === Ke[1] &&
                o[2] === Ke[2] &&
                (o[3] || ('http:' === o[1] ? '80' : '443')) === (Ke[3] || ('http:' === Ke[1] ? '80' : '443')))
            ))),
          ...
          return T;
        (u = dt.event && d.global) && 0 == dt.active++ && dt.event.trigger('ajaxStart'),
          (d.type = d.type.toUpperCase()),
          (d.hasContent = !Be.test(d.type)),
          (r = d.url),
          d.hasContent ||
            (d.data && ((r = d.url += (Fe.test(r) ? '&' : '?') + d.data), delete d.data),
            !1 === d.cache &&
              (d.url = He.test(r) ? r.replace(He, '$1_=' + Re++) : r + (Fe.test(r) ? '&' : '?') + '_=' + Re++)),
          d.ifModified &&
            (dt.lastModified[r] && T.setRequestHeader('If-Modified-Since', dt.lastModified[r]),
      ...
      dt.each(['get', 'post'], function (t, e) {
        dt[e] = function (t, i, n, o) {
          return (
            ...
            dt.ajax(dt.extend({ url: t, type: e, dataType: o, data: i, success: n }, dt.isPlainObject(t) && t))
          );
        };
      }),
        ...
        void 0 !== t.ActiveXObject
          ? function () {
              return this.isLocal
                ...
                : it.documentMode > 8
                ? K()
                : (/^(get|post|head|put|delete|options)$/i.test(this.type) && K()) || J();
            }
          : K);
    var oi = 0,
      si = {},
                ...
                r.send((e.hasContent && e.data) || null),
                  (i = function (t, n) {
                    ...
                    if (i && (n || 4 === r.readyState))
                      if ((delete si[a], (i = void 0), (r.onreadystatechange = dt.noop), n))
    ...
    dt.ajaxSetup({
      ...
      dt.ajaxPrefilter('json jsonp', function (e, i, n) {
        ...
        return a || 'jsonp' === e.dataTypes[0]
          ? ((o = e.jsonpCallback = dt.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback),
            a
              ? (e[a] = e[a].replace(li, '$1' + o))
              : !1 !== e.jsonp && (e.url += (Fe.test(e.url) ? '&' : '?') + e.jsonp + '=' + o),
      ...
      (dt.parseHTML = function (t, e, i) {
        ...
        return n
          ? [e.createElement(n[1])]
          : ((n = v([t], e, o)), o && o.length && dt(o).remove(), dt.merge([], n.childNodes));
      });
    var ui = dt.fn.load;
      ...
      return (
        ...
        r.length > 0 &&
          dt
            ...
            .done(function (t) {
              (s = arguments), r.html(n ? dt('<div>').append(dt.parseHTML(t)).find(n) : t);
            })
            .always(
              i &&
                function (t, e) {
      ...
      (dt.offset = {
        setOffset: function (t, e, i) {
          ...
          'static' === u && (t.style.position = 'relative'),
            ...
            (s = dt.css(t, 'top')),
            (l = dt.css(t, 'left')),
            ('absolute' === u || 'fixed' === u) && dt.inArray('auto', [s, l]) > -1
            ...
            function (t, n, o) {
              ...
              return void 0 === o
                ? s
                  ...
                  : t[n]
                : void (s ? s.scrollTo(i ? dt(s).scrollLeft() : o, i ? o : dt(s).scrollTop()) : (t[n] = o));
            },
            t,
            n,
            arguments.length,
    ...
    return (
      (dt.noConflict = function (e) {
        return t.$ === dt && (t.$ = hi), e && t.jQuery === dt && (t.jQuery = ci), dt;
      }),
      e || (t.jQuery = t.$ = dt),
      dt
    );
  ...
  jQuery.extend(jQuery.easing, {
    ...
    easeInOutElastic: function (t, e, i, n, o) {
      ...
      return e < 1
        ? a * Math.pow(2, 10 * (e -= 1)) * Math.sin(((e * o - s) * (2 * Math.PI)) / r) * -0.5 + i
        : a * Math.pow(2, -10 * (e -= 1)) * Math.sin(((e * o - s) * (2 * Math.PI)) / r) * 0.5 + n + i;
    },
            ...
            this.$element.find('[data-stellar-ratio]').each(function () {
              ...
              e.options.showElement(d),
                d.data('stellar-startingLeft')
                  ? (d.css('left', d.data('stellar-startingLeft')), d.css('top', d.data('stellar-startingTop')))
                  : (d.data('stellar-startingLeft', d.css('left')), d.data('stellar-startingTop', d.css('top'))),
                (s = d.position().left),
                (r = d.position().top),
          ...
          this.options.parallaxBackgrounds &&
            ...
            e.each(function () {
              ...
              f.data('stellar-backgroundStartingLeft')
                ? h(f, f.data('stellar-backgroundStartingLeft'), f.data('stellar-backgroundStartingTop'))
              ...
              this.options.hideDistantElements &&
                ((f =
                  ...
                  (a + t.width > (t.isFixed ? 0 : c) &&
                    a < (t.isFixed ? 0 : c) + this.viewportWidth + this.viewportOffsetLeft)),
                (p =
                  !this.options.verticalScrolling ||
                  (l + t.height > (t.isFixed ? 0 : d) &&
                    l < (t.isFixed ? 0 : d) + this.viewportHeight + this.viewportOffsetTop))),
              f && p
  ...
  (function (t) {
    ...
    (t.flexslider = function (i, n) {
      ...
      var s,
        ...
        l =
          ('ontouchstart' in window || a || (window.DocumentTouch && document instanceof DocumentTouch)) &&
          o.vars.touch,
      ...
      t.data(i, 'flexslider', o),
        (g = {
          init: function () {
            (o.animating = !1),
              ...
              '' !== o.vars.controlsContainer &&
                (o.controlsContainer = t(o.vars.controlsContainer).length > 0 && t(o.vars.controlsContainer)),
              '' !== o.vars.manualControls &&
                (o.manualControls = t(o.vars.manualControls).length > 0 && t(o.vars.manualControls)),
              '' !== o.vars.customDirectionNav &&
                (o.customDirectionNav = 2 === t(o.vars.customDirectionNav).length && t(o.vars.customDirectionNav)),
              o.vars.randomize &&
              ...
              o.vars.slideshow &&
                ...
                (o.vars.pauseInvisible && g.pauseInvisible.isHidden()) ||
                  (o.vars.initDelay > 0 ? (o.startTimeout = setTimeout(o.play, o.vars.initDelay)) : o.play())),
              m && g.asNav.setup(),
              ...
              (o.asNav = !0),
                ...
                a
                  ...
                  : o.slides.on(u, function (e) {
                      ...
                      var i = t(this),
                        n = i.index();
                      0 >= i.offset().left - t(o).scrollLeft() && i.hasClass(r + 'active-slide')
          ...
          controlNav: {
            ...
            setupPaging: function () {
              var e,
                ...
                s = 1;
              if (
                ((o.controlNavScaffold = t('<ol class="' + r + 'control-nav ' + r + n + '"></ol>')), o.pagingCount > 1)
              )
                for (var a = 0; a < o.pagingCount; a++) {
                  if (
                    (void 0 === (i = o.slides.eq(a)).attr('data-thumb-alt') && i.attr('data-thumb-alt', ''),
                    (altText =
                      '' !== i.attr('data-thumb-alt') ? (altText = ' alt="' + i.attr('data-thumb-alt') + '"') : ''),
                    (e =
                      'thumbnails' === o.vars.controlNav
                        ? '<img src="' + i.attr('data-thumb') + '"' + altText + '/>'
                        : '<a href="#">' + s + '</a>'),
              ...
              o.controlsContainer
                ...
                o.controlNavScaffold.delegate('a, img', u, function (e) {
                  if ((e.preventDefault(), '' === c || c === e.type)) {
                    ...
                    i.hasClass(r + 'active') ||
                      ((o.direction = n > o.currentSlide ? 'next' : 'prev'), o.flexAnimate(n, o.vars.pauseOnAction));
                  }
                ...
                o.controlNav.bind(u, function (e) {
                  if ((e.preventDefault(), '' === c || c === e.type)) {
                    var i = t(this),
                      n = o.controlNav.index(i);
                    i.hasClass(r + 'active') ||
                      (n > o.currentSlide ? (o.direction = 'next') : (o.direction = 'prev'),
            ...
            setup: function () {
              ...
              o.customDirectionNav
                ...
                ? (t(o.controlsContainer).append(e),
                  (o.directionNav = t('.' + r + 'direction-nav li a', o.controlsContainer)))
                : (o.append(e), (o.directionNav = t('.' + r + 'direction-nav li a', o))),
                g.directionNav.update(),
                o.directionNav.bind(u, function (e) {
                  e.preventDefault();
                  var i;
                  ('' === c || c === e.type) &&
                    ((i = t(this).hasClass(r + 'next') ? o.getTarget('next') : o.getTarget('prev')),
                    o.flexAnimate(i, o.vars.pauseOnAction)),
                    '' === c && (c = e.type),
          ...
          pausePlay: {
            setup: function () {
              ...
              o.controlsContainer
                ? (o.controlsContainer.append(e), (o.pausePlay = t('.' + r + 'pauseplay a', o.controlsContainer)))
          ...
          touch: function () {
            ...
            a
                          ...
                          : void (
                              ...
                              !f &&
                                ...
                                (e.vars.animationLoop ||
                                  (r =
                                    w /
                                    ((0 === e.currentSlide && 0 > w) || (e.currentSlide === e.last && w > 0)
                                      ? Math.abs(w) / s + 2
                                      : 1)),
                  ...
                  function (i) {
                    ...
                    if (o) {
                      if (o.animatingTo === o.currentSlide && !g && null !== r) {
                        ...
                        o.canAdvance(u) && ((Number(new Date()) - l < 550 && Math.abs(a) > 50) || Math.abs(a) > s / 2)
              ...
              : ((u = function (r) {
                ...
                (c = function (i) {
                  (v = i.touches[0].pageX), (y = i.touches[0].pageY), (r = h ? t - y : t - v);
                  (!(g = h ? Math.abs(r) < Math.abs(v - e) : Math.abs(r) < Math.abs(y - e)) ||
                    ...
                    !f &&
                      ...
                      (o.vars.animationLoop ||
                        (r /=
                          (0 === o.currentSlide && 0 > r) || (o.currentSlide === o.last && r > 0)
                            ? Math.abs(r) / s + 2
                            : 1),
                ...
                (m = function (a) {
                  if (
                    (i.removeEventListener('touchmove', c, !1), o.animatingTo === o.currentSlide && !g && null !== r)
                  ) {
                    var u = d ? -r : r,
                      h = u > 0 ? o.getTarget('next') : o.getTarget('prev');
                    o.canAdvance(h) && ((Number(new Date()) - l < 550 && Math.abs(u) > 50) || Math.abs(u) > s / 2)
                      ? o.flexAnimate(h, o.vars.pauseOnAction)
                      : f || o.flexAnimate(o.currentSlide, o.vars.pauseOnAction, !0);
                  }
                  i.removeEventListener('touchend', m, !1), (t = null), (e = null), (r = null), (n = null);
                }),
        ...
        (o.flexAnimate = function (e, i, n, s, a) {
          if (
            ...
            m && 1 === o.pagingCount && (o.direction = o.currentItem < e ? 'next' : 'prev'),
            ...
            if (
              ...
              l
                ...
                : (o.slides
                    .eq(o.currentSlide)
                    .css({ zIndex: 1 })
                    .animate({ opacity: 0 }, o.vars.animationSpeed, o.vars.easing),
                  o.slides
                    .eq(e)
                    .css({ zIndex: 2 })
                    .animate({ opacity: 1 }, o.vars.animationSpeed, o.vars.easing, o.wrapup));
            else {
              var c,
                v,
                y,
        ...
        (o.wrapup = function (t) {
          f ||
            p ||
            (0 === o.currentSlide && o.animatingTo === o.last && o.vars.animationLoop
              ? o.setProps(t, 'jumpEnd')
              : o.currentSlide === o.last && 0 === o.animatingTo && o.vars.animationLoop && o.setProps(t, 'jumpStart')),
            (o.animating = !1),
        ...
        (o.canAdvance = function (t, e) {
          ...
          return (
            !!e ||
            !(!m || o.currentItem !== o.count - 1 || 0 !== t || 'prev' !== o.direction) ||
            ((!m || 0 !== o.currentItem || t !== o.pagingCount - 1 || 'next' === o.direction) &&
              !(t === o.currentSlide && !m) &&
              (!!o.vars.animationLoop ||
                ((!o.atEnd || 0 !== o.currentSlide || t !== i || 'next' === o.direction) &&
                  (!o.atEnd || o.currentSlide !== i || 0 !== t || 'next' !== o.direction))))
          );
        }),
              ...
              'init' === e &&
                (l
                  ...
                  : o.slides
                      ...
                      .eq(o.currentSlide)
                      .css({ zIndex: 2 })
                      .animate({ opacity: 1 }, o.vars.animationSpeed, o.vars.easing)),
              o.vars.smoothHeight && g.smoothHeight();
          else {
            var i, n;
            'init' === e &&
              ...
              (o.cloneCount = 0),
              (o.cloneOffset = 0),
              d && ((n = t.makeArray(o.slides).reverse()), (o.slides = t(n)), o.container.empty().append(o.slides))),
              o.vars.animationLoop &&
                !p &&
                ((o.cloneCount = 2),
                (o.cloneOffset = 1),
                ...
                o.container
                  .append(g.uniqueID(o.slides.first().clone().addClass('clone')).attr('aria-hidden', 'true'))
                  .prepend(g.uniqueID(o.slides.last().clone().addClass('clone')).attr('aria-hidden', 'true'))),
        ...
        (o.update = function (t, e) {
          o.doMath(),
            p ||
              (t < o.currentSlide ? (o.currentSlide += 1) : t <= o.currentSlide && 0 !== t && (o.currentSlide -= 1),
              (o.animatingTo = o.currentSlide)),
            o.vars.controlNav &&
              !o.manualControls &&
              (('add' === e && !p) || o.pagingCount > o.controlNav.length
                ? g.controlNav.update('add')
                : (('remove' === e && !p) || o.pagingCount < o.controlNav.length) &&
                  (p && o.currentSlide > o.last && ((o.currentSlide -= 1), (o.animatingTo -= 1)),
  ...
  (function (t, e) {
    ...
    function o(o) {
      if ((n(), 'string' == typeof o && (o = document.querySelector(o)), o && 'object' == typeof o && o.nodeType)) {
        ...
        for (var c = (u.isBorderBox = 'border-box' == r.boxSizing), h = 0; h < l; h++) {
          var d = a[h],
            p = r[d],
            f = parseFloat(p);
          u[d] = isNaN(f) ? 0 : f;
  ...
  (function (t) {
    ...
    function i(e) {
      if (
        ...
        e.durationTime && 'function' != typeof e.durationTime && (e.durationTime = w(e.durationTime)),
        'now' == e.scrollDefault)
      )
      ...
      if (
        ('string' === t.type(e.timeFormat) && e.timeFormat.match(/[gh]/) && (e._twelveHourTime = !0),
        ...
        for (var n in e.disableTimeRanges)
          e.disableTimeRanges[n] = [w(e.disableTimeRanges[n][0]), w(e.disableTimeRanges[n][1])];
        ...
        for (n = e.disableTimeRanges.length - 1; n > 0; n--)
          e.disableTimeRanges[n][0] <= e.disableTimeRanges[n - 1][1] &&
            ((e.disableTimeRanges[n - 1] = [
              Math.min(e.disableTimeRanges[n][0], e.disableTimeRanges[n - 1][0]),
              Math.max(e.disableTimeRanges[n][1], e.disableTimeRanges[n - 1][1]),
            ]),
    ...
    function n(e) {
      ...
      if ((n && n.length && (n.remove(), e.data('timepicker-list', !1)), i.useSelect))
        ...
        (n = t('<ul />', { class: 'ui-timepicker-list' })),
          (r = t('<div />', { class: 'ui-timepicker-wrapper', tabindex: -1 }))
            ...
            .append(n);
      if (i.noneOption)
        if ((!0 === i.noneOption && (i.noneOption = i.useSelect ? 'Time...' : 'None'), t.isArray(i.noneOption))) {
      ...
      for (var l = p, S = 0; f >= l; S++, l += 60 * k(S)) {
        ...
        if (i.useSelect) (I = t('<option />', { value: E })).text(E);
          ...
          var I = t('<li />');
          I.addClass(x / 2 > D % x ? 'ui-timepicker-am' : 'ui-timepicker-pm'), I.data('time', b(D, i)), I.text(E);
        }
        ...
        C > T &&
          ...
          m[T] &&
            D >= m[T][0] &&
            D < m[T][1] &&
            (i.useSelect ? I.prop('disabled', !0) : I.addClass('ui-timepicker-disabled'))),
          n.append(I);
      }
      if ((r.data('timepicker-input', e), e.data('timepicker-list', r), i.useSelect))
          ...
          n.on('mousedown click', 'li', function (i) {
            e.off('focus.timepicker'),
              e.on('focus.timepicker-ie-hack', function () {
                e.off('focus.timepicker-ie-hack'), e.on('focus.timepicker', _.show);
              }),
              a(e) || e[0].focus(),
    ...
    function r(e) {
      if (e.target != window) {
        ...
        i.closest('.ui-timepicker-input').length ||
          ...
          (_.hide(), t(document).unbind('.ui-timepicker'), t(window).unbind('.ui-timepicker'));
      }
    }
    function a(t) {
    ...
    function c(e, i) {
      if ('timepicker' != i) {
        ...
        if (!n.is(':focus') || (e && 'change' == e.type)) {
          ...
          var r = !1;
          if (
            (null !== o.minTime && null !== o.maxTime && (s < o.minTime || s > o.maxTime) && (r = !0),
    ...
    function d(t, e, i) {
      ...
      return t.data('ui-timepicker-value') != e
        ? (t.data('ui-timepicker-value', e),
          'select' == i
            ? t.trigger('selectTime').trigger('changeTime').trigger('change', 'timepicker')
    ...
    function f(i) {
      ...
      if (!o || !e(o)) {
        ...
        _.show.call(n.get(0)), (o = n.data('timepicker-list')), a(n) || n.focus();
      }
      switch (i.keyCode) {
        case 13:
          ...
          return (
            s.length
              ? s.is(':first-child') ||
                ...
                s.prev().position().top < s.outerHeight() && o.scrollTop(o.scrollTop() - s.outerHeight()))
          ...
          return (
            0 === (s = o.find('.ui-timepicker-selected')).length
              ...
              : s.is(':last-child') ||
                ...
                s.next().position().top + 2 * s.outerHeight() > o.outerHeight() &&
    ...
    function g(t) {
      ...
      return (
        ...
        (n.length && (i = n.data('time')), null !== i && ('string' != typeof i && (i = y(i, e)), d(t, i, 'select')), !0)
      );
    }
    function v(t, e) {
      t = Math.abs(t);
      ...
      for (var a, l, u = '', c = 0; c < i.timeFormat.length; c++)
        switch ((l = i.timeFormat.charAt(c))) {
          ...
          case 'G':
            ...
            break;
          case 'h':
            0 !== (a = r.getHours() % 12) && 10 > a && (a = '0' + a), (u += 0 === a ? '12' : a);
            break;
          case 'H':
            (a = r.getHours()), e === x && (a = i.show2400 ? 24 : 0), (u += a > 9 ? a : '0' + a);
            break;
          case 'i':
    ...
    var x = 86400,
      ...
      C = {
        ...
        roundingFunction: function (t, e) {
          ...
          var i = t % (60 * e.step);
          return (i -= (e.minTime || 0) % (60 * e.step)) >= 30 * e.step ? (t += 60 * e.step - i) : (t -= i), b(t, e);
        },
        scrollDefault: null,
        selectOnBlur: !1,
        show2400: !1,
      ...
      _ = {
        ...
        show: function (i) {
          ...
          if ((i && i.preventDefault(), s.useSelect)) o.data('timepicker-list').focus();
            ...
            if (
              !o.prop('readonly') &&
              ((c && 0 !== c.length && 'function' != typeof s.durationTime) || (n(o), (c = o.data('timepicker-list'))),
              !e(c))
            ) {
              o.data('ui-timepicker-value', o.val()), u(o, c), _.hide(), c.show();
              var d = {};
              s.orientation.match(/r/)
                ...
                : (d.left = o.offset().left + parseInt(c.css('marginLeft').replace('px', ''), 10));
              't' ==
              (s.orientation.match(/t/)
                ? 't'
                : s.orientation.match(/b/)
                ? 'b'
                : o.offset().top + o.outerHeight(!0) + c.outerHeight() > t(window).height() + t(window).scrollTop()
                ? 't'
                : 'b')
                ? (c.addClass('ui-timepicker-positioned-top'),
                  (d.top = o.offset().top - c.outerHeight() + parseInt(c.css('marginTop').replace('px', ''), 10)))
                : (c.removeClass('ui-timepicker-positioned-top'),
                  (d.top = o.offset().top + o.outerHeight() + parseInt(c.css('marginTop').replace('px', ''), 10))),
                c.offset(d);
        ...
        getTime: function (t) {
          ...
          t || (t = new Date());
          var n = new Date(t);
          return n.setHours(i / 3600), n.setMinutes((i % 3600) / 60), n.setSeconds(i % 60), n.setMilliseconds(0), n;
        },
        isVisible: function () {
    ...
    u.prototype = {
      ...
      _process_options: function (e) {
        ...
        (i.startView = Math.max(i.startView, i.minViewMode)),
          !0 !== i.multidate &&
            ...
            !1 !== i.multidate ? (i.multidate = Math.max(0, i.multidate)) : (i.multidate = 1)),
          ...
          this.picker.removeClass(
            ...
            'auto' !== this.o.orientation.x
              ...
              : (this.picker.addClass('datepicker-orient-left'),
                l.left < 0 ? (h -= l.left - 10) : l.left + e > n && (h = n - e - 10));
          var p,
            f,
            m = this.o.orientation.y;
          'auto' === m &&
            ((p = -s + l.top - i), (f = s + o - (l.top + u + i)), (m = Math.max(p, f) === f ? 'top' : 'bottom')),
      ...
      getClassNames: function (e) {
        var i = [],
          ...
          s = new Date();
        return (
          e.getUTCFullYear() < n || (e.getUTCFullYear() === n && e.getUTCMonth() < o)
            ? i.push('old')
            : (e.getUTCFullYear() > n || (e.getUTCFullYear() === n && e.getUTCMonth() > o)) && i.push('new'),
      ...
      fill: function () {
        ...
        for (var v, y = []; d.valueOf() < g; ) {
          ...
          (v = t.unique(v)),
            y.push(
              '<td class="' + v.join(' ') + '"' + (e ? ' title="' + e + '"' : '') + '>' + d.getUTCDate() + '</td>'
            ),
          ...
          switch (this.viewMode) {
            case 0:
              ...
              i <= this.o.startDate.getUTCMonth()
                ...
                this.o.endDate !== 1 / 0 && e >= this.o.endDate.getUTCFullYear() && i >= this.o.endDate.getUTCMonth()
              ...
              (e = 37 === t.keyCode ? -1 : 1),
                t.ctrlKey
                  ...
                  ? ((i = this.moveMonth(this.dates.get(-1) || n(), e)),
                    ...
                    this._trigger('changeMonth', this.viewDate))
                  : ((i = new Date(this.dates.get(-1) || n())).setUTCDate(i.getUTCDate() + e),
                    (o = new Date(r)).setUTCDate(r.getUTCDate() + e)),
                this.dateWithinRange(i) &&
                  ((this.focusDate = this.viewDate = o), this.setValue(), this.fill(), t.preventDefault());
              break;
            case 38:
            case 40:
              if (!this.o.keyboardNavigation) break;
              (e = 38 === t.keyCode ? -1 : 1),
                t.ctrlKey
                  ...
                  ? ((i = this.moveMonth(this.dates.get(-1) || n(), e)),
                    (o = this.moveMonth(r, e)),
                    this._trigger('changeMonth', this.viewDate))
                  : ((i = new Date(this.dates.get(-1) || n())).setUTCDate(i.getUTCDate() + 7 * e),
      ...
      m = {
        ...
        parseDate: function (e, n, o) {
          ...
          if (e) {
            ...
            (y.M = y.MM = y.mm = y.m), (y.dd = y.d), (e = i(e.getFullYear(), e.getMonth(), e.getDate(), 0, 0, 0));
            var w = n.parts.slice();
            if (
              (h.length !== w.length &&
                (w = t(w)
              ...
              for (l = 0, b = w.length; l < b; l++) {
                if (((d = parseInt(h[l], 10)), (r = w[l]), isNaN(d)))
                  switch (r) {
                    case 'MM':
                      (p = t(f[o].months).filter(s)), (d = t.inArray(p[0], f[o].months) + 1);
                      break;
                    case 'M':
              ...
              for (l = 0; l < v.length; l++)
                (T = v[l]) in g && !isNaN(g[T]) && ((x = new Date(e)), y[T](x, g[T]), isNaN(x) || (e = x));
            }
            return e;
          }
        },
        formatDate: function (e, i, n) {
          ...
          for (var s = t.extend([], i.separators), r = 0, a = i.parts.length; r <= a; r++)
    ...
    return function (t, e, i, n) {
      var o = {
        ...
        detectFeatures: function () {
          ...
          for (
            var l, u, c = ['transform', 'perspective', 'animationName'], h = ['', 'webkit', 'Moz', 'ms', 'O'], d = 0;
            d < 4;
            d++
          ) {
            e = h[d];
            for (var p = 0; p < 3; p++)
              (l = c[p]), (u = e + (e ? l.charAt(0).toUpperCase() + l.slice(1) : l)), !i[l] && u in t && (i[l] = u);
            e &&
              !i.raf &&
              ((e = e.toLowerCase()),
      ...
      o.detectFeatures(),
        o.features.oldIE &&
          (o.bind = function (t, e, i, n) {
            e = e.split(' ');
            for (var o, s = (n ? 'detach' : 'attach') + 'Event', r = 0; r < e.length; r++)
              if ((o = e[r]))
      ...
      var a,
        ...
        It = function (t, e, i, n, o) {
          (!xt || (o && o !== s.currItem)) && (n /= o ? o.fitRatio : s.currItem.fitRatio),
            (t[E] = y + e + 'px, ' + i + 'px' + w + ' scale(' + n + ')');
        },
        At = function (t) {
          it &&
            (t &&
              (g > s.currItem.fitRatio ? xt || (ri(s.currItem, !1, !0), (xt = !0)) : xt && (ri(s.currItem), (xt = !1))),
            It(it, dt.x, dt.y, g));
        },
        Ot = function (t) {
        ...
        Bt = function () {
          if (E) {
            ...
            return (y = 'translate' + (e ? '3d(' : '(')), void (w = P.perspective ? ', 0px)' : ')');
          }
          (E = 'left'),
        ...
        ee = {
          ...
          init: function () {
            if (!a && !l) {
              ...
              for (
                (P.animationName && P.transform && !n) || (r.showAnimationDuration = r.hideAnimationDuration = 0),
                  i = 0;
                i < wt.length;
                i++
              )
          ...
          goTo: function (t) {
            var e = (t = Ct(t)) - c;
            (vt = e), (c = t), (s.currItem = Qe(c)), (ft -= e), Nt(gt.x * ft), Jt(), (nt = !1), s.updateCurrItem();
          },
          next: function () {
            s.goTo(c + 1);
          },
              ...
              if (!(t && i < 2)) {
                ...
                for (var n = 0; n < i; n++)
                  vt > 0
                    ...
                    : ((e = T.pop()), T.unshift(e), d--, Mt(d * gt.x, e.el.style), s.setContent(e, c + i - n - 1 - 1));
                if (it && 1 === Math.abs(vt)) {
                  var o = Qe(C);
          ...
          zoomTo: function (t, e, i, n, s) {
            ...
            var c = function (e) {
              1 === e
                ...
                : ((g = (t - l) * e + l), (dt.x = (a.x - u.x) * e + u.x), (dt.y = (a.y - u.y) * e + u.y)),
                s && s(e),
                At(1 === e);
            };
        ...
        _e = {},
        ke = function (t, e) {
          return (_e.prevent = !Ce(t.target, r.isClickableElement)), St('preventDragEvent', t, e, _e), _e.prevent;
        },
        Se = function (t, e) {
        ...
        Ne = function (t) {
          ...
          return (
            I
              ...
              ? t.touches &&
                t.touches.length > 0 &&
                ((Me[0] = Se(t.touches[0], Ae)), t.touches.length > 1 && (Me[1] = Se(t.touches[1], Oe)))
              : ((Ae.x = t.pageX), (Ae.y = t.pageY), (Ae.id = ''), (Me[0] = Ae)),
            Me
          );
        },
        Le = function (t, e) {
          ...
          return (
            ...
            (it
              ? 'h' !== ot ||
                ...
                V ||
                (u
                  ? (l > et.min[t] && ((i = r.panEndFriction), et.min[t], (n = et.min[t] - ht[t])),
                    (n <= 0 || h < 0) && Xe() > 1
                      ? ((a = c), h < 0 && c > le.x && (a = le.x))
                      : et.min.x !== et.max.x && (o = l))
                  : (l < et.max[t] && ((i = r.panEndFriction), et.max[t], (n = ht[t] - et.max[t])),
                    (n <= 0 || h > 0) && Xe() > 1
                      ? ((a = c), h > 0 && c < le.x && (a = le.x))
                      : et.min.x !== et.max.x && (o = l)))
              : (a = c),
            'x' !== t)
              ? void (nt || Z || (g > s.currItem.fitRatio && (dt[t] += e[t] * i)))
              : (void 0 !== a && (Nt(a, !0), (Z = a !== le.x)),
                et.min.x !== et.max.x && (void 0 !== o ? (dt.x = o) : Z || (dt.x += e.x * i)),
                void 0 !== a)
          );
        },
        $e = function (t) {
        ...
        Pe = function () {
          if (G) {
            var t = G.length;
            if (0 !== t)
              if (($t(ie, G[0]), (oe.x = ie.x - se.x), (oe.y = ie.y - se.y), K && t > 1)) {
                ...
                var n = 1,
                  ...
                  a = qt();
                if (i < o)
                  if (r.pinchToClose && !lt && v <= s.currItem.initialZoomLevel) {
                    var l = 1 - (o - i) / (o / 1.2);
        ...
        Re = function (t) {
          ...
          var c = -1;
          if (
            (0 === u && ((B = !1), o.unbind(window, p, s), be(), K ? (c = 0) : -1 !== pe && (c = Dt() - pe)),
            (pe = 1 === u ? Dt() : -1),
            (a = -1 !== c && c < 150 ? 'zoom' : 'swipe'),
            K && u < 2 && ((K = !1), 1 === u && (a = 'zoomPointerUp'), St('zoomGestureEnded')),
            (G = null),
            Q || V || nt || q)
          )
            if ((Jt(), W || (W = Fe()), W.calculateSwipeSpeed('x'), q))
              if (Ie() < r.verticalDragRange) s.close();
                ...
                te('verticalDrag', 0, 1, 300, o.easing.cubic.out, function (t) {
                  (dt.y = (s.currItem.initialPosition.y - h) * t + h), Et((1 - d) * t + d), At();
                }),
                  St('onVerticalDrag', 1);
              }
            else {
            ...
            i = {
              ...
              calculateOverBoundsAnimOffset: function (t, e) {
                i.backAnimStarted[t] ||
                  (dt[t] > et.min[t]
                    ...
                    : dt[t] < et.max[t] && (i.backAnimDestination[t] = et.max[t]),
              ...
              panAnimLoop: function () {
                if (
                  ...
                  return (dt.x = Math.round(dt.x)), (dt.y = Math.round(dt.y)), At(), void Gt('zoomPan');
              },
            };
          return i;
        },
        ...
        We = function (t, e) {
          ...
          return (
            i || d > fe.x == e.lastFlickSpeed.x > 0
              ? ((h = Math.abs(e.lastFlickSpeed.x) > 0 ? p / Math.abs(e.lastFlickSpeed.x) : 333),
                (h = Math.min(h, 400)),
                (h = Math.max(h, 250)))
              : (h = 333),
            he === c && (i = !1),
            ...
            te('mainScroll', fe.x, d, h, o.easing.cubic.out, Nt, function () {
              Jt(), (nt = !1), (he = -1), (i || he !== c) && s.updateCurrItem(), St('mainScrollAnimComplete');
            }),
      ...
      var Ue,
                    ...
                    var s = l.w / e.w,
                      ...
                      p = function (e) {
                        1 === e
                          ...
                          : ((g = (s - u) * e + u), (dt.x = (l.x - r.x) * e + r.x), (dt.y = (l.y - z - r.y) * e + r.y)),
                          At(),
        ...
        ii = function (t, e, i) {
          if (t.src && !t.loadError) {
            ...
            if (!i) return;
            return (
              ei(t, t.w * i, t.h * i), n && i === t.initialZoomLevel && (t.initialPosition = t.bounds.center), t.bounds
            );
          }
          return (
            (t.w = t.h = 0),
        ...
        si = function (t, e) {
          if (t.src && t.loadError && t.container)
            return e && (t.container.innerHTML = ''), (t.container.innerHTML = r.errorMsg.replace('%url%', t.src)), !0;
        },
        ri = function (t, e, i) {
          if (t.src) {
        ...
        ai = function () {
          if (Je.length) {
            for (var t, e = 0; e < Je.length; e++)
              (t = Je[e]).holder.index === t.index && ni(t.index, t.item, t.baseDiv, t.img, 0, t.clearPlaceholder);
            Je = [];
          }
        };
      Tt('Controller', {
        publicMethods: {
          ...
          setContent: function (t, e) {
            ...
            if (l) {
              ...
              if (
                (!l.src && l.html && (l.html.tagName ? u.appendChild(l.html) : (u.innerHTML = l.html)),
                si(l),
                ii(l, pt),
                    ...
                    if (a) {
                      if (t && t.index === e) {
                        ...
                        i.imageAppended
                          ...
                          : P.transform && (nt || Ve)
                          ? Je.push({ item: i, baseDiv: u, img: i.img, index: e, holder: t, clearPlaceholder: !0 })
                          : ni(0, i, u, i.img, 0, !0);
                      }
                ...
                l.loading || oi(l),
                  s.allowProgressiveImg() &&
                    (!Ye && P.transform
                      ? Je.push({ item: l, baseDiv: u, img: l.img, index: e, holder: t })
                      : ni(0, l, u, l.img, 0, !0));
              }
              Ye || e !== c ? Ot(l) : ((it = u.style), Ge(l, n || l.img)), (t.el.innerHTML = ''), t.el.appendChild(u);
            } else t.el.innerHTML = '';
          },
          ...
          handleMouseWheel: function (t) {
            ...
            if ((t.stopPropagation(), (hi.x = 0), 'deltaX' in t))
              ...
              t.wheelDeltaX && (hi.x = -0.16 * t.wheelDeltaX),
                t.wheelDeltaY ? (hi.y = -0.16 * t.wheelDeltaY) : (hi.y = -0.16 * t.wheelDelta);
            else {
            ...
            var e = dt.x - hi.x,
              i = dt.y - hi.y;
            (r.modal || (e <= et.min.x && e >= et.max.x && i <= et.min.y && i >= et.max.y)) && t.preventDefault(),
              s.panTo(e, i);
          },
      ...
      var di,
        ...
        Ei = function () {
          if ((fi && clearTimeout(fi), Zt || B)) fi = setTimeout(Ei, 500);
            ...
            Ci
              ? '#' + i !== window.location.hash && history[wi ? 'replaceState' : 'pushState']('', document.title, n)
              : wi
              ? Ti.replace(n)
              : (Ti.hash = i),
              (wi = !0),
                ...
                (vi = !0),
                  bi ||
                    (xi
                      ...
                      ? (Ti.hash = yi)
                      : Ci
                      ? history.pushState('', document.title, Ti.pathname + Ti.search)
                      : (Ti.hash = '')),
                  Si();
              };
              kt('unbindEvents', function () {
    ...
    return function (t, e) {
      var i,
        ...
        S = function (t) {
          ...
          for (var i, n, o = (t.target || t.srcElement).getAttribute('class') || '', s = 0; s < U.length; s++)
            (i = U[s]).onTap && o.indexOf('pswp__' + i.name) > -1 && (i.onTap(), (n = !0));
          if (n) {
              ...
              clearTimeout(f),
                (f = setTimeout(function () {
                  t.currItem && t.currItem.loading
                    ? (!t.allowProgressiveImg() || (t.currItem.img && !t.currItem.img.naturalWidth)) && j(!1)
                    : j(!0);
        ...
        W = function (t) {
          ...
          if (D()) {
            ...
            if (g.captionEl && 'auto' === r.bottom)
              if (
                (s ||
                  ((s = e.createEl('pswp__caption pswp__caption--fake')).appendChild(
        ...
        q = function () {
          h('onVerticalDrag', function (t) {
            C && t < 0.95 ? x.hideControls() : !C && t >= 0.95 && x.showControls();
          });
          var t;
          h('onPinchClose', function (e) {
            C && e < 0.9 ? (x.hideControls(), (t = !0)) : t && !C && e > 0.9 && x.showControls();
          }),
        ...
        (x.update = function () {
          C && t.currItem
            ? (x.updateIndexIndicator(),
              g.captionEl && (g.addCaptionHTMLFn(t.currItem, o), E(o, 'caption--empty', !t.currItem.title)),
              (T = !0))
            : (T = !1),
            _ || O(),
            I();
        ...
        (x.onGlobalTap = function (i) {
          ...
          if (!v)
            if (i.detail && 'mouse' === i.detail.pointerType) {
              ...
              (g.tapToToggleControls && (C ? x.hideControls() : x.showControls()),
    ...
    (d = {
      ...
      (o.Pipe = [
          ...
          run: function () {
            ...
            for (this._coordinates = [], e = 0, i = this._clones.length + this._items.length; i > e; e++)
              (t = this._mergers[this.relative(e)]),
                ...
                (s +=
                  (this.settings.autoWidth ? this._items[this.relative(e)].width() + this.settings.margin : o * t) * n),
        ...
        },
        {
          ...
          run: function () {
            ...
            if (
              (this.$stage.css(o),
              (o = { width: this.settings.autoWidth ? 'auto' : n - this.settings.margin }),
              (o[this.settings.rtl ? 'margin-left' : 'margin-right'] = this.settings.margin),
              ...
              for (e = 0, i = this._coordinates.length; i > e; e++)
                (o.width =
                  Math.abs(this._coordinates[e]) - Math.abs(this._coordinates[e - 1] || 0) - this.settings.margin),
      ...
      (o.prototype.initialize = function () {
        ...
        this.$element.addClass('owl-loading'),
          (this.$stage = t('<' + this.settings.stageElement + ' class="owl-stage"/>').wrap(
        ...
        this.state.isTouch &&
          (this.state.isScrolling ||
            ...
            this.settings.loop
              ? this.op(this.drag.currentX, '>', this.coordinates(this.minimum())) && 'right' === this.state.direction
                ...
                : this.op(this.drag.currentX, '<', this.coordinates(this.maximum())) &&
                  ...
                  (this.drag.currentX +=
                    (this.settings.center && this.coordinates(0)) - this.coordinates(this._items.length))
              : ((a = this.coordinates(this.settings.rtl ? this.maximum() : this.minimum())),
            ...
            (this.drag.distance > 8 || this.drag.distance < -8) &&
              (i.preventDefault !== n ? i.preventDefault() : (i.returnValue = !1), (this.state.isSwiping = !0)),
      ...
      (o.prototype.getTransformProperty = function () {
        var t;
        return (
          (t = e.getComputedStyle(this.$stage.get(0), null).getPropertyValue(this.vendorName + 'transform')),
      ...
      (o.prototype.normalize = function (e, i) {
        ...
        return !t.isNumeric(e) || 1 > o
          ? n
          : (e = this._clones.length ? ((e % o) + o) % o : Math.max(this.minimum(i), Math.min(this.maximum(i), e)));
      }),
      ...
      (o.prototype.maximum = function (t) {
        ...
        if (!s.loop && s.center) e = this._items.length - 1;
          ...
          if (s.loop || s.center) e = this._items.length + s.items;
            ...
            for (
              revert = s.rtl ? 1 : -1, i = this.$stage.width() - this.$element.width();
        ...
        return e === n
          ...
          : (this.settings.center
              ? ((i = this._coordinates[e]),
                (i += ((this.width() - i + (this._coordinates[e - 1] || 0)) / 2) * (this.settings.rtl ? -1 : 1)))
      ...
      (o.prototype.to = function (i, n) {
        if (this.settings.loop) {
          ...
          a < this.settings.items && !1 === l
            ...
            : a >= u - this.settings.items && !0 === l && ((s = r - this._items.length), this.reset(s)),
      ...
      (o.prototype.transitionEnd = function (t) {
        return (
          (t === n || (t.stopPropagation(), (t.target || t.srcElement || t.originalTarget) === this.$stage.get(0))) &&
        ...
        var e = t.proxy(function (e, i) {
          return t.proxy(function (t) {
            t.relatedTarget !== this &&
              (this.suppress([i]), e.apply(this, [].slice.call(arguments, 1)), this.release([i]));
          }, this);
        }, this);
        t.each(
          {
      ...
      (o.prototype.watchVisibility = function () {
        ...
        i(this.$element.get(0)) ||
          ...
          (this.e._checkVisibile = e.setInterval(
            t.proxy(function () {
              i(this.$element.get(0)) &&
                (this.$element.removeClass('owl-hidden'), this.refresh(), e.clearInterval(this.e._checkVisibile));
            }, this),
            500
          )));
      }),
      ...
      (o.prototype.trigger = function (e, i, n) {
        ...
        return (
          this._supress[e] ||
            ...
            this.settings && 'function' == typeof this.settings[s] && this.settings[s].apply(this, r)),
          r
        );
      }),
        ...
        var n,
          ...
          h = function (t) {
            (o = '<div class="owl-video-play-icon"></div>'),
              (n = c.lazyLoad
                ? '<div class="owl-video-tn ' + u + '" ' + l + '="' + t + '"></div>'
        ...
        (this._handlers = {
          'prepared.owl.carousel': t.proxy(function (e) {
            this._core.settings.dotsData &&
              this._templates.push(t(e.content).find('[data-dot]').andSelf('[data-dot]').attr('data-dot'));
          }, this),
      ...
      (e.prototype.initialize = function () {
        ...
        n.dotsData || (this._templates = [t('<div>').addClass(n.dotClass).append(t('<span>')).prop('outerHTML')]),
          (n.navContainer && n.dotsContainer) ||
            (this._controls.$container = t('<div>').addClass(n.controlsClass).appendTo(this.$element)),
          (this._controls.$indicators = n.dotsContainer
            ? t(n.dotsContainer)
            : t('<div>').hide().addClass(n.dotsClass).appendTo(this._controls.$container)),
          ...
          (e = n.navContainer
            ? t(n.navContainer)
            : t('<div>').addClass(n.navContainerClass).prependTo(this._controls.$container)),
      ...
      (e.prototype.update = function () {
        ...
        if (('page' !== n.slideBy && (n.slideBy = Math.min(n.slideBy, n.items)), n.dots || 'page' == n.slideBy))
          for (this._pages = [], t = o, e = 0, i = 0; s > t; t++)
            (e >= r || 0 === e) && (this._pages.push({ start: t - o, end: t - o + r - 1 }), (e = 0), ++i),
      ...
      (e.prototype.draw = function () {
        ...
        if (
          ...
          if (((e = this._pages.length - this._controls.$indicators.children().length), o.dotData && 0 !== e)) {
            ...
            e > 0
              ? ((n = new Array(e + 1).join(this._templates[0])), this._controls.$indicators.append(n))
      ...
      (e.prototype.to = function (e, i, n) {
        ...
        n
          ...
          : ((o = this._pages.length),
            t.proxy(this._overrides.to, this._core)(this._pages[((e % o) + o) % o].start, i));
      }),
          ...
          setTimeout(
            t.proxy(function () {
              n[o](null == s[e] ? this.options[e] : s[e]),
                'loadingText' == e
                  ? ((this.isLoading = !0), n.addClass(i).attr(i, i).prop(i, !0))
                  : this.isLoading && ((this.isLoading = !1), n.removeClass(i).removeAttr(i).prop(i, !1));
            }, this),
            0
          );
      }),
        ...
        if ((this.$element.trigger(c), !c.isDefaultPrevented())) {
          ...
          return (
            t.support.transition && this.$element.hasClass('slide')
              ...
              : (o.removeClass('active'), s.addClass('active'), (this.sliding = !1), this.$element.trigger(d)),
            r && this.cycle(),
            this
          );
        }
          ...
          o.hasClass('open') &&
            ((i && 'click' == i.type && /input|textarea/i.test(i.target.tagName) && t.contains(o[0], i.target)) ||
              ...
              i.isDefaultPrevented() ||
                (n.attr('aria-expanded', 'false'), o.removeClass('open').trigger(t.Event('hidden.bs.dropdown', s)))));
        }));
    }
      ...
      (e.prototype.show = function () {
        ...
        if (this.hasContent() && this.enabled) {
          ...
          t.support.transition && this.$tip.hasClass('fade')
            ? s.one('bsTransitionEnd', g).emulateTransitionEnd(e.TRANSITION_DURATION)
            : g();
        }
      }),
        ...
        if ((this.$element.trigger(r), !r.isDefaultPrevented()))
          return (
            ...
            t.support.transition && s.hasClass('fade')
              ? s.one('bsTransitionEnd', n).emulateTransitionEnd(e.TRANSITION_DURATION)
              : n(),
            (this.hoverState = null),
            this
          );
